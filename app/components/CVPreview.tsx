...
const CVPreview = forwardRef<HTMLDivElement, Props>(
  (
    ...
    // Debug
    console.log("🖼️ CVPreview - file:", file ? "File présent" : "null", "| profileImage:", personalDetails.profileImage ? `présent (${personalDetails.profileImage.substring(0, 30)}...)` : "absent");
